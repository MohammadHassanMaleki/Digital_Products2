...
class Payment(models.Model):
    ...
    STATUS_TRANSLATIONS = {
        ...
        STATUS_ERROR : _('Payment has encountered an error. Our team will check'),
    ...
    consumed_code = models.PositiveIntegerField(_('cosumed reference code'),null=True, db_index=True )
