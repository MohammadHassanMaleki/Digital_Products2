...
from django.contrib.auth.models import (
    AbstractBaseUser, PermissionsMixin, BaseUserManager, send_mail)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    admin-complant permissions.

    username, password, and email are required. other fields are optinal
    """
    username = models.CharField( _('usename'), max_length=32, unique=True,
                                 help_text= _('Required. 30 characters....'),
                                 validators=[
                                     validators.RegexValidator(r'^[a-zA-Z][a-zA-z0-9_\.]+$',
                                                               _('Enter valid username '), 'invalid')],
    ...
    is_staff = models.BooleanField(_('staff status'), default=False,
                                   help_text=_('Destinate wheather the user can log into this site.'))
    is_active = models.BooleanField(_('active'), default=True,
                                    help_text=_('Destinate wheather this user should be treated as active.'))
...
class UserProfile(models.Model):
    ...
    nick_name = models.CharField(_(' nike name'), max_length=150, blank=True)
    avatar = models.ImageField(_('avatar'), blank=True)
    birthday = models.DateField(_('birthday'), null=True, blank=True)
    gender = models.NullBooleanField(_('gender'), help_text='female is False, male is True')
